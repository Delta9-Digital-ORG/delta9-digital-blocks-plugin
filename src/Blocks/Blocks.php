 ...
 *
 * @package Delta9DigitalBlocksPlugin\Blocks
 */

declare(strict_types=1);

namespace Delta9DigitalBlocksPlugin\Blocks;

use Delta9DigitalBlocksPluginVendor\EightshiftLibs\Blocks\AbstractBlocks;

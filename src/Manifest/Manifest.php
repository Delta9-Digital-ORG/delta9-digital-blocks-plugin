 ...
 *
 * @package Delta9DigitalBlocksPlugin\Manifest
 */

declare(strict_types=1);

namespace Delta9DigitalBlocksPlugin\Manifest;

use Delta9DigitalBlocksPlugin\Config\Config;
use Delta9DigitalBlocksPluginVendor\EightshiftLibs\Manifest\AbstractManifest;
